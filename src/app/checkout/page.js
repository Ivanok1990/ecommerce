...
function CheckoutContent() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const purchaseCode = `GL${Date.now()}-${Math.random().toString(36).substr(2, 5).toUpperCase()}`;
      ...
      const orderDetails = {
        ...
        taxes,
        total: finalTotal,
        fullName: formData.fullName, // Include the user's name
      };
      ...
      params.set('order', JSON.stringify(orderDetails));
